    ...
    const fetchWasteProducts = async () => {
        try {
            ...
            if (response.ok) {
                ...
                const flattenedProducts = data.map((item) => ({
                    ...item,
                    images: item.images || [], // Ensure images are an array
                }));
                setWasteProducts(flattenedProducts);
            } else {
                ...
                {filteredProducts.map((product) => (
                    ...
                    >
                        <img
                            ...
                            alt={product.title || "Product Image"} // Provide a fallback alt text
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-sm text-gray-600">
                                Seller: {product.seller} ({product.sellerEmail})
                            </p>
